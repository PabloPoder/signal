...
final chronologyCommands = [
  ChronologyCommand(
    ...
    aliases: ['/inspect', '/access', '/view'],
    description: "Mounts selected node for active inspection.",
    successLogs: [
  ...
  // ChronologyCommand(
  //   type: ChronologyCommandType.back,
  //   aliases: ['/back', '/return'],
  //   description: "Segments timeline using specific criteria.",
  //   successLogs: [
  ...
  //   aliases: ['/find', '/locate', '/seek'],
  //   description: "Scans registry for text pattern matches.",
  //   successLogs: [
  ...
  //   aliases: ['/select', '/target', '/mark'],
  //   description: "Locks target node into buffer pipeline.",
  //   successLogs: [
